...
%%%%%%%%%%%%%%%%%%%%%%%%%% LATEX DIFF %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% use as : latexdiff ancientfile.tex newfile.tex > revisionfile.tex

% diff can be remove by revisionfile.tex > revisionfile.tex
...
\lipsum[1]
\todo[color=yellow]{abstract}

\todo[inline,color=yellow]{Les nom de genre, section, sous-section, locus et loci en italiques, c'est du latin.}
...
\todo[color=red,inline]{Marque page de fin de doc = 13!!}
