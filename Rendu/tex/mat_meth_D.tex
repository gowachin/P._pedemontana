...
Les analyses de génétique des populations ont été réalisés sous \DIFdelbegin \DIFdel{Rstudio \mbox{%DIFAUXCMD
\citep{RTeam2017} }\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{R }\DIFaddend avec différents packages. 
