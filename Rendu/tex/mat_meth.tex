...
Ce test d'admixture développé par \citet{Durand2011} propose une statistique basé sur quatre lignées partageant un ancêtre commun, selon la fréquence de SNPs observés avec un motif particulier.
...
Sur cette topologie on attend deux allèles présents en fin de branche avec "A" l'allèle ancestral et "B" l'allèle alternatif.
...
Un introgression entre "P3" et "P1" verrais donc une plus grande proportion de locis a la configuration "BABA". 
